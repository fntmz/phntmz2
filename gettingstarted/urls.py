...
urlpatterns = [
    ...
    path("feedback", hello.views.feedback, name="feedback"),
    ...
    path("admin/feedback", hello.views.feedbackAdmin, name="feedback_admin"),
    path("admin/feedback/show/<id>", hello.views.showFeedback, name="show_feedback"),
    path("admin/feedback/delete/<id>", hello.views.deleteFeedback, name="delete_feedback"),
    path("admin/feedback/review/<id>", hello.views.reviewFeedback, name="review_feedback"),
